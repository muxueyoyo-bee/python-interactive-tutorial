...
来源：scikit-learn/scikit-learn — sklearn\\callback\\__init__.py`,
  content: "",
  defaultCode: `# 定义 __all__ 暴露以下公共 API: AutoPropagatedCallback, CallbackContext, CallbackSupportMixin ...`,
  answer,
