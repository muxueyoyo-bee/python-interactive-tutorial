...
编写 try/except 块：尝试 int('not a number')，捕获 (LookupError, TypeError), (TypeError, AttributeError, UnsupportedOperation), DecodeError，并在 finally 中打印 'Cleanup complete'。
