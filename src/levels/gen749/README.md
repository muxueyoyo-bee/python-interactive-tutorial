# 第749关: 编写带类型标注的函数: create

> 真实案例：python-poetry/poetry 的 `src\poetry\layouts\layout.py` 中使用了这个模式。
...
```python
def create(self, path: Path, with_tests: bool, with_pyproject: bool) -> None:
