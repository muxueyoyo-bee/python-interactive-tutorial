...
const level: LevelType = {
  key: "gen261",
  title: "定义异常类层级: SolverProblemError",
  category: "进阶",
...
来源：python-poetry/poetry — src\\poetry\\puzzle\\exceptions.py`,
  content: "",
  defaultCode: `class SolverProblemError(Exception):
    pass

# 定义 OverrideNeededError，继承自 SolverProblemError`,
  answer: "",
