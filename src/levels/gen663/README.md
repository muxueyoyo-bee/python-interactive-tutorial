# 第663关: 编写带类型标注的函数: model_json_schema
...
```python
def model_json_schema(cls, by_alias: bool, ref_template: str, schema_generator: type[GenerateJsonSchema], mode: JsonSchemaMode) -> dict[str, Any]:
