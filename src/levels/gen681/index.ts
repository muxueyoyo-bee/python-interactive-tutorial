...
const level: LevelType = {
  key: "gen681",
  title: "编写带类型标注的函数: generate_arguments_schema",
  category: "中级",
...
来源：pydantic/pydantic — pydantic\\experimental\\arguments_schema.py`,
  content: "",
  defaultCode: `# 编写带类型标注的函数 generate_arguments_schema`,
  answer,
