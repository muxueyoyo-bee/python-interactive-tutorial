# 第859关: 编写带类型标注的函数: run_generic_build

> 真实案例：sphinx-doc/sphinx 的 `sphinx\cmd\make_mode.py` 中使用了这个模式。
...
```python
def run_generic_build(self, builder: str, doctreedir: str | os.PathLike[str] | None) -> int:
    return f'run_generic_build result'
```
