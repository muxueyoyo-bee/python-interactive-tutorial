...
编写 try/except 块：尝试 int('not a number')，捕获 (CookieLoadError, DownloadError), (TypeError, ValueError), AttributeError，并在 finally 中打印 'Cleanup complete'。
