# 第885关: 编写带类型标注的函数: drop_constraint
...
```python
def drop_constraint(cls, operations: Operations, constraint_name: str, table_name: str, type_: Optional[str]) -> None:
    return f'drop_constraint result'
```
